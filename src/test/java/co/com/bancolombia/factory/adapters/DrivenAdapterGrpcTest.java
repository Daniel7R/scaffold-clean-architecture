...
class DrivenAdapterGrpcTest {
  private static final String TEST_DIR = getTestDir(DrivenAdapterGrpcTest.class);
  ...
  void setup() throws IOException, CleanException {
    ...
    Project project = setupProject(DrivenAdapterGrpcTest.class, GenerateStructureTask.class);
  ...
  @Test
  void shouldGenerateGrpcDrivenAdapter() throws IOException, CleanException {
    // Arrange
    task.setType("GRPC");
    ...
    assertFilesExistsInDir(
        TEST_DIR + "/infrastructure/driven-adapters/grpc-consumer/",
        "build.gradle",
        "src/main/java/co/com/bancolombia/grpc/GrpcConsumerAdapter.java",
        "src/main/java/co/com/bancolombia/grpc/config/GrpcClientConfig.java",
        "src/main/proto/service.proto",
        "src/test/java/co/com/bancolombia/grpc/GrpcConsumerAdapterTest.java");
  }
  ...
  void shouldGenerateBuildGradleWithProtobufPlugin() throws IOException, CleanException {
    ...
    // Assert
    assertFileContains(
        TEST_DIR + "/infrastructure/driven-adapters/grpc-consumer/build.gradle",
        "com.google.protobuf",
  ...
  void shouldGenerateProtoFile() throws IOException, CleanException {
    ...
    // Assert
    assertFileContains(
        TEST_DIR + "/infrastructure/driven-adapters/grpc-consumer/src/main/proto/service.proto",
        "syntax = \"proto3\"",
  ...
  @Test
  void shouldAddGrpcClientConfigToProperties() throws IOException, CleanException {
    // Arrange
    task.setType("GRPC");
  ...
  void shouldAddDependencyToAppService() throws IOException, CleanException {
    ...
    assertFileContains(
        ...
        "implementation project(':grpc-consumer')");
  }
  ...
  void shouldAddModuleToSettings() throws IOException, CleanException {
    ...
    // Assert
    assertFileContains(TEST_DIR + "/settings.gradle", "grpc-consumer");
  }
}
